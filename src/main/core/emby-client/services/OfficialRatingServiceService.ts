...
/* tslint:disable */
/* eslint-disable */
import type { QueryResult_UserLibrary_OfficialRatingItem } from '../models/QueryResult_UserLibrary_OfficialRatingItem';
...
export class OfficialRatingServiceService {
    ...
    public getOfficialratings(
        ...
        nameLessThan?: string,
    ): CancelablePromise<QueryResult_UserLibrary_OfficialRatingItem> {
