...
/* tslint:disable */
/* eslint-disable */
import type { NameValuePair } from '../models/NameValuePair';
import type { QueryResult_UserLibrary_TagItem } from '../models/QueryResult_UserLibrary_TagItem';
...
export class TagServiceService {
    ...
    public getAudiocodecs(
        ...
        nameLessThan?: string,
    ): CancelablePromise<QueryResult_UserLibrary_TagItem> {
    ...
    public getArtistsPrefixes(
        ...
        nameStartsWith?: string,
        nameLessThan?: string,
    ): CancelablePromise<Array<NameValuePair>> {
        return this.httpRequest.request({
            method: 'GET',
